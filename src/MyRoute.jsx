...
const MyRoute = () => {
  return (
   ...
   <ul className="flex Several-Links gap-5">
      <li>
        <NavLink className="Link flex" to="/MyPortfolio/home">
          <CiHome className="md:hidden block text-2xl" />
          <span className="md:block hidden">About</span>
        </NavLink>
      </li>
      <li>
        <NavLink className="Link flex" to="/MyPortfolio/skills">
      ...
      <li>
        <NavLink className="Link flex" to="/MyPortfolio/work">
      ...
      <li>
      <NavLink className="Link flex" to="/MyPortfolio/contact">
